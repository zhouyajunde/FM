...
-(void) startRotation
{
    ...
    //set ImgView
//    self.playStateView.image = [UIImage imageNamed:@"player_status_btn"];
...
{
    //set ImgView
//    self.playStateView.image = [UIImage imageNamed:@"player_window_status_btn"];
